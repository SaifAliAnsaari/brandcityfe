                            ...
                            <div role="main" id="content">
                                <article class="blog_entry clearfix">
                                    ...
                                    <div class="entry-content">
                                        <div class="featured-thumb"><a href="#"><img alt="blog-img4" src="/resources/images/blog-img1.jpg"></a></div>
                                        <div class="entry-content">
                                            ...
                                            <p>Aliquam laoreet consequat malesuada. Integer vitae diam sed dolor
                                                ...
                                                sodales. Donec eu cursus velit. Proin nunc lacus, gravida mollis dictum
                                                ut, vulputate eu turpis. Sed felis sapien, commodo in iaculis in,
                                                feugiat sed enim. Sed nunc ipsum, fermentum varius dignissim vitae,
                                                blandit et ante.Maecenas sagittis, lorem sed congue egestas, lectus
                                                purus congue nisl, ac molestie enim ligula nec eros. Sed leo tortor,
                                                tincidunt sit amet elementum vel, eleifend at orci. Maecenas ut turpis
                                            ...
                                            <p>Curabitur at vestibulum sem. Aliquam vehicula neque ac nibh suscipit
                                                ...
                                                imperdiet enim urna in justo. Mauris pulvinar tortor lorem. Aliquam sed
                                                nisl in ipsum tincidunt ultrices.</p>
                                    ...
                                    <footer class="entry-meta"> This entry was posted in <a rel="category tag" title="View all posts in First Category"
                                            href="#first-category">First Category</a> On
                                        ...
                                        <ul class="commentlist">
                                                ...
                                                <div class="comment-wrapper">
                                                    <div class="comment-author vcard">
                                                        <p class="gravatar"><a href="#"><img width="60" height="60" alt="avatar"
                                                                    src="/resources/images/avatar60x60.jpg"></a></p>
                                                        <span class="author">John Doe</span>
                                                    </div>
                                                    <!--comment-author vcard-->
                                                    <div class="comment-meta">
                                                        <time datetime="2014-07-10T07:26:28+00:00" class="entry-date">Thu,
                                                            Jul 10, 2014 07:26:28 am</time>
                                                        . </div>
                                                    <!--comment-meta-->
                                            ...
                                            <li class="comment">
                                                <div class="comment-wrapper">
                                                    ...
                                                    <!--comment-author vcard-->
                                                    <div class="comment-meta">
                                                        <time datetime="2014-07-10T07:27:08+00:00" class="entry-date">Thu,
                                                            Jul 10, 2014 07:27:08 am</time>
                                                        . </div>
                                                    <!--comment-meta-->
                                                    <div class="comment-body"> Curabitur at vestibulum sem. Aliquam
                                                        vehicula neque ac nibh suscipit ultrices. Morbi interdum
                                            ...
                                            <li class="comment">
                                                <div class="comment-wrapper">
                                                    ...
                                                    <!--comment-author vcard-->
                                                    <div class="comment-meta">
                                                        <time datetime="2014-07-10T07:27:56+00:00" class="entry-date">Thu,
                                                            Jul 10, 2014 07:27:56 am</time>
                                                        . </div>
                                                    <!--comment-meta-->
                                                    <div class="comment-body"> Curabitur at vestibulum sem. Aliquam
                                                        vehicula neque ac nibh suscipit ultrices. Morbi interdum
                                            ...
                                            <li class="comment">
                                                <div class="comment-wrapper">
                                                    ...
                                                    <!--comment-author vcard-->
                                                    <div class="comment-meta">
                                                        <time datetime="2014-07-10T07:28:32+00:00" class="entry-date">Thu,
                                                            Jul 10, 2014 07:28:32 am</time>
                                                        . </div>
                                                    <!--comment-meta-->
                                                    <div class="comment-body"> Curabitur at vestibulum sem. Aliquam
                                                        vehicula neque ac nibh suscipit ultrices. Morbi interdum
                                    ...
                                    <div class="comments-form-wrapper clearfix">
                                        ...
                                        <form class="comment-form" method="post" id="postComment">
                                            ...
                                            <div class="field">
                                                ...
                                                <input type="text" class="input-text validate-email" title="Email" id="email"
                                                    name="user_email">
                                            </div>
                                            <div class="clear"></div>
            ...
            <div class="col-right sidebar col-sm-3 col-xs-12">
                <div role="complementary" class="widget_wrapper13" id="secondary">
                    <div class="popular-posts widget widget__sidebar wow" id="recent-posts-4">
                        ...
                        <div class="widget-content">
                            <ul class="posts-list unstyled clearfix">
                                <li>
                                    <figure class="featured-thumb"> <a href="blog_single_post.html"> <img width="80"
                                                height="53" alt="blog image" src="/resources/images/blog-img1.jpg"> </a>
                                    </figure>
                                    <!--featured-thumb-->
                                ...
                                <li>
                                    <figure class="featured-thumb"> <a href="blog_single_post.html"> <img width="80"
                                                height="53" alt="blog image" src="/resources/images/blog-img2.jpg"> </a>
                                    </figure>
                                    <!--featured-thumb-->
                                ...
                                <li>
                                    <figure class="featured-thumb"> <a href="blog_single_post.html"> <img width="80"
                                                height="53" alt="blog image" src="/resources/images/blog-img3.jpg"> </a>
                                    </figure>
                                    <!--featured-thumb-->
                                    <h4><a title="Aliquam eget sapien placerat" href="#/aliquam-eget-sapien-placerat">Aliquam
                                            eget sapien placerat</a></h4>
                                    <p class="post-meta"><i class="icon-calendar"></i>
                                ...
                                <li>
                                    <figure class="featured-thumb"> <a href="blog_single_post.html"> <img width="80"
                                                height="53" alt="blog image" src="/resources/images/blog-img4.jpg"> </a>
                                    </figure>
                                    <!--featured-thumb-->
                    ...
                    <div class="popular-posts widget widget_categories wow" id="categories-2">
                        ...
                        <ul>
                            <li class="cat-item"><a href="#/first-category">First Category</a></li>
                            <li class="cat-item"><a href="#/second-category">Second Category</a></li>
                        </ul>
                    </div>
                    <!-- Banner Ad Block -->
                    <div class="ad-spots widget widget__sidebar">
                        <h3 class="widget-title"><span>Ad Spots</span></h3>
                        <div class="widget-content"><a href="#" title=""><img alt="offer banner" src="/resources/images/RHS-banner-img.jpg"></a></div>
                    </div>
                    <!-- Banner Text Block -->
